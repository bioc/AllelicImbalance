...
1 hets the number of heterozygote SNPs
2 homs the number of homozygote SNPs
3 mean.fr the mean of fractions for all hets
4 sd.fr the standard deviation for the fractions for all hets
5 mean.delta the mean of the delta fractions for all hets
6 sd.delta the standard deviation for the delta fractions for all hets
7 ai.up the number of hets significantly up-regulated in one allele.
8 ai.down the number of hets significantly down-regulated in one allele.
